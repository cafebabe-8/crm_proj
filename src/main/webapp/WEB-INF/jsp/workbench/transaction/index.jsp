...
<head>
	...
	<script type="text/javascript">
		jQuery(function($) {
			// 用死数据跳转到详情页
			$("#jump_to_detail").click(function () {
				location = "/tran/detail.html?id=04600ec74bbe48ba9baffcfe36996c83";
			})
	...
	<div style="width: 100%; position: absolute;top: 5px;">
		...
		<div style="position: relative;top: 10px;">
			<table class="table table-hover">
				...
				<tr>
					<td><input type="checkbox" /></td>
					<td><a style="text-decoration: none; cursor: pointer;" id="jump_to_detail">动力节点-交易01</a></td>
					<td>动力节点</td>
					<td>谈判/复审</td>
					<td>新业务</td>
					<td>zhangsan</td>
