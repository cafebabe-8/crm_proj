...
<head>
	...
	<script type="text/javascript">
		...
		jQuery(function($) {
			...
			// 点击退出按钮时 清除session中的对象
			$("#confirm_exit").click(function () {
				$.removeCookie('username',{domain:'127.0.0.1',path:'/'});
				$.removeCookie('pwd',{domain:'127.0.0.1',path:'/'});
	...
	<div class="modal fade" id="exitModal" role="dialog">
		<div class="modal-dialog" role="document" style="width: 30%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
					<button id="confirm_exit" type="button" class="btn btn-primary" data-dismiss="modal">确定</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="center" style="position: absolute;top: 50px; bottom: 0px; left: 0px; right: 0px;">
		...
		<div id="navigation" style="left: 0px; width: 18%; position: relative; height: 100%; overflow:auto;">
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass"><a id="customer_page" href="customer/index.html" target="workareaFrame"><span class="glyphicon glyphicon-user"></span> 客户</a></li>
